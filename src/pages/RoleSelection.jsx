...
function RoleSelection() {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-slate-950 font-sans">
            ...
            <div className="absolute top-12 right-36 z-20 flex items-center gap-3">
                <button
                    onClick={() => navigate('/camp-admin/login')}
                    className="flex items-center gap-2 rounded-full border border-white/25 bg-white/10 px-4 py-2.5 text-sm font-semibold text-white/85 backdrop-blur-md hover:border-white/50 hover:bg-white/20 hover:text-white"
                >
                ...
                <button
                    ...
                    className="group flex items-center gap-2 rounded-full border border-white bg-white px-5 py-2.5 text-sm font-bold text-slate-900 shadow-[0_4px_20px_rgba(0,0,0,0.5)] hover:bg-danger-600 hover:text-white hover:shadow-[0_6px_24px_rgba(220,38,38,0.5)]"
                >
            ...
            <div className="relative z-10 flex min-h-screen w-full flex-col justify-center px-6 py-24 sm:px-10 lg:pl-44 lg:pr-0 xl:pl-60">
                <div className="max-w-6xl">
                    <div
                        className="mb-7 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-4 py-2 text-sm font-bold tracking-wide text-primary-100 backdrop-blur-md"
                    >
                    ...
                    <h1
                        className="mb-5 flex flex-col items-start gap-1 text-5xl font-black leading-[1.15] tracking-tight text-white drop-shadow-[0_4px_24px_rgba(0,0,0,0.8)] sm:text-6xl lg:text-7xl"
                    >
                    ...
                    <p
                        className="mb-12 max-w-2xl text-lg text-slate-200 md:text-xl"
                    >
                    ...
                    <div className="grid gap-7 sm:grid-cols-2">
                        ...
                        <div
                            ...
                            className="group relative cursor-pointer overflow-hidden rounded-2xl border border-white/15 bg-slate-950/50 p-8 shadow-xl backdrop-blur-md hover:border-danger-400/60 hover:bg-slate-950/70"
                        >
                            <div className="absolute inset-y-0 left-0 w-1.5 bg-gradient-to-b from-danger-500 to-orange-400"></div>

                            <div className="flex items-start justify-between gap-4">
                                <div className="flex items-start gap-3">
                                    <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-xl bg-danger-500 text-white shadow-lg shadow-danger-500/40">
                            ...
                            <button className="group/btn relative mt-7 w-full overflow-hidden rounded-lg bg-gradient-to-r from-danger-600 to-danger-500 py-4 text-xl font-bold text-white shadow-lg shadow-danger-500/30 group-hover:shadow-danger-500/50">
                        ...
                        <div
                            ...
                            className="group relative cursor-pointer overflow-hidden rounded-2xl border border-white/15 bg-slate-950/50 p-8 shadow-xl backdrop-blur-md hover:border-success-400/60 hover:bg-slate-950/70"
                        >
                            <div className="absolute inset-y-0 left-0 w-1.5 bg-gradient-to-b from-success-500 to-primary-400"></div>

                            <div className="flex items-start justify-between gap-2">
                                <div className="flex items-start gap-3">
                                    <div className="flex h-16 w-16 flex-shrink-0 items-center justify-center rounded-xl bg-success-500 text-white shadow-lg shadow-success-500/40">
                            ...
                            <button className="group/btn relative mt-7 w-full overflow-hidden rounded-lg bg-gradient-to-r from-success-600 to-success-500 py-4 text-xl font-bold text-white shadow-lg shadow-success-500/30 group-hover:shadow-success-500/50">
                                <span className="pointer-events-none absolute inset-0 -translate-x-full bg-gradient-to-r from-transparent via-white/25 to-transparent"></span>
                                <span className="relative inline-flex items-center gap-2">
                                    I Want to Help
                                    <IconArrowRight className="h-5 w-5 group-hover/btn:translate-x-1" />
                    ...
                    {/* Hotline bar */}
                    <div
                        className="mt-8 flex items-center gap-4 rounded-2xl border border-white/20 bg-slate-950/60 px-6 py-5 shadow-xl backdrop-blur-md"
                    >
