...
function Donations() {
    ...
    return (
        <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 font-sans">
            ...
            <div className="relative z-10 mx-auto max-w-[1600px] px-6 py-8 sm:px-10">
                <motion.div
                ...
                {successMessage && (
                    <div className="max-w-2xl mx-auto mb-6 flex items-center gap-3 rounded-xl border border-success-400/20 bg-success-500/10 p-4 text-center text-success-200">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-6xl mx-auto">
                    <div>
                        {stripePromise ? (
                            ...
                            <div className="rounded-xl border border-white/10 bg-white/[0.05] p-6 text-center text-slate-400">
