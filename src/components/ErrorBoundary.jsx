                    ...
                    <div className="relative z-10 max-w-md w-full rounded-xl border border-white/10 bg-white/[0.05] p-8 text-center">
                        ...
                        <div className="space-y-3">
                            <button
                                ...
                                className="w-full border-2 border-slate-900 dark:border-white bg-white dark:bg-transparent hover:bg-slate-900 dark:hover:bg-white text-slate-900 dark:text-white hover:text-white dark:hover:text-slate-900 px-6 py-3 rounded-lg font-bold transition-colors duration-150"
                            >
                                Reload Page
                            </button>
                            <button
                                onClick={() => window.history.back()}
                                className="w-full border border-white/20 bg-white/10 text-slate-900 dark:text-white px-6 py-3 rounded-lg font-medium hover:bg-white/20 transition-colors"
                            >
                                Go Back
                            </button>
                            <button
