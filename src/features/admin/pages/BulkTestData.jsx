...
import { generateAllTestData, generateMissingPersons, generateDisasters, generateAnimalRescues, generateCamps, generateDonations } from '@/features/admin/utils/bulkTestData';
        ...
        <div className="page-shell">
            ...
            <div className="relative z-10 mx-auto max-w-4xl px-4 py-8 sm:px-6">
                ...
                <div className="mb-8">
                    <button
                        onClick={() => navigate('/')}
                        className="text-slate-400 hover:text-slate-900 dark:hover:text-white mb-4 flex items-center gap-2 transition-colors text-sm font-medium"
                    >
                        ← Back to Home
                    </button>
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            <h1 className="text-xl font-bold text-slate-900 dark:text-white md:text-2xl">Bulk Test Data Generator</h1>
                ...
                <div className="card mb-6">
                    <h3 className="font-bold text-xl text-slate-900 dark:text-white mb-2">🚀 Generate All Test Data</h3>
                ...
                <div className="card mt-6">
                    <h3 className="font-bold text-slate-900 dark:text-white mb-3">📦 What's Generated:</h3>
